...
/////////ziplining
 	var first = function(){
 		...
 		// },1000)
 		// $("#addWords").animate({
 		// 	append: "I've only ziplined once in my life, but I loved it. Sometimes I'm hesitant to try new things but moments like these remind me that it's worth the risk to try something new every now and then.",
 		// }, 5000);
 	}
